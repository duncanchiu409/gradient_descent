...
class GradientDescent{
    public:
        ...
        std::vector<double> gradient_descent(std::vector<double> x, std::vector<double> y, double alpha, double w_initial_value, double b_initial_value, int number_of_iterations);
};
